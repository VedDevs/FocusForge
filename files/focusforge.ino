 ...
 * ╔══════════════════════════════════════════════════════════════╗
 * ║                     FocusForge v1.0                         ║
 * ║         RFID Study Accountability System — Firmware         ║
 * ║                                                             ║
 * ║  Hardware: ESP32 + MFRC522 RFID Reader + 16x2 I2C LCD      ║
 * ║  Author  : Vedant                                           ║
 * ║  Repo    : github.com/yourusername/focusforge               ║
 * ╚══════════════════════════════════════════════════════════════╝
 *
 * ── QUICK START ──────────────────────────────────────────────────
 *   1. Open config.h and fill in your WiFi, Firebase, UIDs
 *   2. Select Board: ESP32 Dev Module
 *   3. Upload → done
 *
 * ── WIRING ───────────────────────────────────────────────────────
 *   MFRC522         ESP32
 *   SDA      →      GPIO 5   (PIN_RFID_SS  in config.h)
 *   SCK      →      GPIO 18
 *   MOSI     →      GPIO 23
 *   MISO     →      GPIO 19
 *   RST      →      GPIO 4   (PIN_RFID_RST in config.h)
 *   3.3V     →      3.3V     ⚠ NOT 5V
 *   GND      →      GND
 *
 *   LCD I2C         ESP32
 *   SDA      →      GPIO 21  (PIN_LCD_SDA  in config.h)
 *   SCL      →      GPIO 22  (PIN_LCD_SCL  in config.h)
 *   VCC      →      5V
 *   GND      →      GND
 *
 *   Buzzer          ESP32
 *   +        →      GPIO 15  (PIN_BUZZER   in config.h)
 *   -        →      GND
 */
...
// ─── Runtime State ───────────────────────────────────────────────────────────
String        claimerID    = "";   // e.g. "user1"
String        claimerName  = "";   // e.g. "user1"
